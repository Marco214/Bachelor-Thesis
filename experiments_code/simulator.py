...
class Simulator:
    def __init__(self, planner, instance_file="BPI Challenge 2017 - instance 2.pickle"):
        self.events = []
        ...
        while self.now <= RUNNING_TIME:
            ...
            # depending to how many resources should be available according to the schedule.
                ...
                if required_resources > 0:
                    ...
                    # changed by marco
                    d = self.available_resources;
                    
                    resources_to_remove = random.sample(list(d), nr_resources_to_remove)
